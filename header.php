...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header">
		<div class="site-branding">
			...
			$loja_integrada_blog_description = get_bloginfo( 'description', 'display' );
			if ( $loja_integrada_blog_description || is_customize_preview() ) :
				?>
				<p class="site-description"><?php echo $loja_integrada_blog_description; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></p>
			<?php endif; ?>
		</div><!-- .site-branding -->
